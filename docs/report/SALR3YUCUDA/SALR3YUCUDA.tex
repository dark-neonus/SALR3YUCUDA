...
\end{align}
where $\beta = 1/T$ is the inverse temperature, $\rho_{i,b}$ is the bulk (average) density of species $i$, and $\Phi_{ij}(\mathbf{r})$ are interaction field contributions defined as convolutions:
\begin{equation}
