...
\begin{figure*}[t]
\centerline{\includegraphics[width=\textwidth]{src/performance_comparison.png}}
\caption{Laptop benchmark runtime for CUDA and CPU across grid sizes.}
\label{fig:laptop_perf}
\end{figure*}

\begin{figure*}[t]
\centerline{\includegraphics[width=\textwidth]{src/speedup_analysis.png}}
\caption{Laptop benchmark speedups: CUDA over CPU (left) and CPU OpenMP scaling (right).}
\label{fig:laptop_speedup}
\end{figure*}

\begin{figure*}[t]
\centerline{\includegraphics[width=\textwidth]{src/performance_real_params_laptop.png}}
...
\begin{figure*}[t]
\centerline{\includegraphics[width=\textwidth]{src/speedup_vs_laptop.png}}
...
\begin{figure*}[t]
\centerline{\includegraphics[width=\textwidth]{src/performance_real_params_cluster.png}}
